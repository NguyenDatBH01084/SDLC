  ...
  <div class="p-8 max-w-md w-full bg-white rounded shadow">
    ...
    <form action="signup_page.php" method="post">
      ...
      <div class="mb-6">
        ...
        <input name="confirm_password" id="confirm_password" type="password" placeholder="Confirm your password" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-indigo-500" required>
      </div>
      ...
      <button type="submit" name="button_login" href="signin_page.php" class="w-full bg-red-500 mt-5 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:bg-indigo-600">Sign In</button>
    </form>
  </div>
